    ...
    <div class="">
        ...
        <div class="container__title">
            ...
            <div class="container__title-search">
                <input type="text" class="container__title-search-input" placeholder="Search..">
                <button class="container__title-search-btn">
                    <i class="container__title-search-btn-icon fa-solid fa-magnifying-glass"></i>
                </button>
            </div>
        </div>
        ...
        <div class="detail__product-title">
            <div class="grid wide">
                <div class="EditAccount">
                    <div>
                        <p class="EditAccount-content"><b>Edit Account</b></p>
                   </div>
                   <div>
                        <p class="EditAccount-info">First Name: 
                            <input type="text" class="EditAccount-info-text">
                        </p>
                   </div>
                   <div>
                        <p class="EditAccount-info">Last Name: 
                            <input type="text" class="EditAccount-info-text">
                        </p>    
                    </div>
                    <div>
                        <p class="EditAccount-info">Email:     
                            <input type="text" class="EditAccount-info-text">
                        </p>
                    </div>
                    <div>
                        <p class="EditAccount-info">Phone: 
                            <input type="text" class="EditAccount-info-text">
                        </p>
                    </div>
                    <div>
                        <p class="EditAccount-info">Address: 
                            <input type="text" class="EditAccount-info-text">
                        </p>
                    </div>
                    <div class="EditAccount-node">
                        <input type="button" value="Confirm" class="EditAccount-Button">
                    </div>
        ...
        <footer class="footer">
            ...
            <div class="footer__text">
                <p>
                    Copyright SkyShop © 2022. All rights reserved
                </p>
            </div>
        </footer>
    </div>
